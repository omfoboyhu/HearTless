...
RIZ_IMG = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/e3443fada61c085b4f6dd.jpg"

Riz_Button = [
        [
        Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/ABOUT_STAR_BOY")
        ],
        [
...
RizX_Button = [
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/TEAM_HEARTLESS_POLICE_OP"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/ABOUT_STAR_BOY")
        ],
        [
